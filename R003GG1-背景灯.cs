...
{
    public class R003GG1 : IBuildingConfig
    {
        public override BuildingDef CreateBuildingDef()
        {
            ...
            //--------------------------
            if (控制台.Instance.R003GG1) { buildingDef.Deprecated = false; } else { buildingDef.Deprecated = true; }
            //--------------------------
            return buildingDef;
        }
