...
{
    public class R020GG1 : IBuildingConfig
    {
        public override BuildingDef CreateBuildingDef()
        {
            ...
            //--------------------------
            if (控制台.Instance.R020GG1) { buildingDef.Deprecated = false; } else { buildingDef.Deprecated = true; }
            //--------------------------
            return buildingDef;
        }
