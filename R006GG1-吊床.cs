...
{
    public class R006GG1 : IBuildingConfig
    {
    ...
    public static class R006GG1L2
    {
        public static void Postfix(BuildingFacades __instance)
        {
            __instance.Add("R006GG1L2",
                STRINGS.BUILDINGS.PREFABS.R006GG1L2.NAME, STRINGS.BUILDINGS.PREFABS.R006GG1L2.EFFECT, PermitRarity.Universal,
                "R006GG1", "R006GG1L2_kanim", DlcManager.AVAILABLE_ALL_VERSIONS);
        }
    }
}
