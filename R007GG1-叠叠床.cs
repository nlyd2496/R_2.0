...
{
    public class R007GG1 : IBuildingConfig
    {
        //-------------------------------------------------------------------------------------------------------
        ...
        public override void DoPostConfigureComplete(GameObject go)
        {
            ...
            ladder.upwardsMovementSpeedMultiplier = SingletonOptions<控制台>.Instance.R007GG1X1;
            ladder.downwardsMovementSpeedMultiplier = SingletonOptions<控制台>.Instance.R007GG1X2;
