...
{
    public class R035GG1 : IBuildingConfig
    {
        public override BuildingDef CreateBuildingDef()
        {
            ...
            //--------------------------
            if (控制台.Instance.R035GG1) { buildingDef.Deprecated = false; } else { buildingDef.Deprecated = true; }
            //--------------------------
            return buildingDef;
        }
        ...
        public override void DoPostConfigureComplete(GameObject go)
        {
            ...
            go.AddOrGetDef<R035GG1K0.Def>();

            go.AddOrGet<R035GG1K1>();
