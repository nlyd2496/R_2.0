...
{
    public class R020GG1K1 : KMonoBehaviour, ISingleSliderControl, ISliderControl
    {
        ...
        public string SliderUnits => UI.UNITSUFFIXES.LIGHT.LUX; //单位
        public string SliderTitleKey => "STRINGS.BUILDINGS.PREFABS.R020GG1.NAME";//窗口名称
        ...
        internal void OnCopySettings(object data) { var component = ((GameObject)data).GetComponent<R020GG1K1>(); if (component == null) return; AA = component.AA; Update(); }
        //--------------------------
    }
}
