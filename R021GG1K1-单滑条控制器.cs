...
{
    public class R021GG1K1 : KMonoBehaviour, ISingleSliderControl, ISliderControl
    {
        ...
        public string SliderTitleKey => "STRINGS.BUILDINGS.PREFABS.R021GG1.NAME";//窗口名称
        ...
        internal void OnCopySettings(object data) { var component = ((GameObject)data).GetComponent<R021GG1K1>(); if (component == null) return; AA = component.AA; Update(); }
        //--------------------------
    }
    /*
    [HarmonyPatch(typeof(Building), "OnSpawn")]
    public class R021GG1K1_1
    {
